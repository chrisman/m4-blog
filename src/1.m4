define(__title, `Backstory')dnl
define(__subtitle, `Motivations and tips for creating backstories')dnl
define(__keywords, `')dnl
define(__timestamp, 2020-08-20)dnl
define(__id, 1)dnl
...
-   [What's a backstory?](#whats-a-backstory)
-   [Why create a backstory?](#why-create-a-backstory)
    -   [Backstory For You](#backstory-for-you)
    -   [Backstory For Your DM](#backstory-for-your-dm)
    -   [Backstory For Your Teammates](#backstory-for-your-teammates)
-   [How to backstory?](#how-to-backstory)
    -   [Rumors](#rumors)
    -   [Puzzle Pieces](#puzzle-pieces)
    -   [Knife Theory](#knife-theory)
    -   [The Megaversal Omnigroovy Background Machine](#the-megaversal-omnigroovy-background-machine)
...
2. **Rumors**: Create some rumors about your character for NPCs to talk about and react to.

3. **The Megaversal Omnigroovy Background Machine**: For extra fun, roll on the M.O.B. Machine tables to fill in some extra detail in your backstory
...
- Pick 1 - 2 teammates. How do you know them?
...
>
> <cite>[source](https://www.reddit.com/r/DnD/comments/775caq/my_friends_and_i_have_something_called_knife/)</cite>
...
[src](https://medium.com/@WordsByJohn/embiggen-your-gamemaster-style-with-rumors-ead973942849)

### The Megaversal Omnigroovy Background Machine

aka The MOB Machine

source: [Risus Companion](https://www.drivethrurpg.com/product/203657/Risus-Companion)
